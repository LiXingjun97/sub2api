export default {
  ...
  userManual: {
      ...
      codex: {
        step1Title: 'Install Codex',
        step1Desc: 'Visit the Codex download page and install the package for your operating system.',
        step2Title: 'Sign in to Codex',
        step2Desc: 'Run the login command in your terminal and follow the prompts to sign in.',
        step3Title: 'Run login command',
        step3Desc: 'Execute the following command in your terminal:',
        step4Title: 'Configure custom API endpoint',
        step4Desc: 'Set the environment variable to point to this platform.',
        step5Title: 'Set environment variable',
        step5Desc: 'Run the following command (use set instead of export on Windows):',
      },
      claude: {
