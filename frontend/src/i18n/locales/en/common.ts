...
userManual: {
    ...
    quickStart: {
      ...
      step3Title: "Step 3: Get and Configure API Key",
      step3Desc: "Click 'API Keys' in the left menu, then 'Create Key'. After getting your Key, click the 'Connect' or 'Use Key' button in the actions column — the system will guide you through configuration step by step.",
      step4Title: "Step 4: Download a Tool and Start",
      step4Desc: "Download the AI tool you want (e.g. Codex) from the Resources section below, then follow the guided setup from the 'Use Key' dialog to complete configuration.",
      ...
      codex: {
        ...
        step2Title: "Step 2: Download Codex Desktop",
        step2Desc: "Open your browser and go to codex.openai.com. Click the big 'Download' button in the middle of the page. The site will automatically detect your operating system.",
        step3Title: "Step 3: Install Codex",
        step3Desc: "Double-click the downloaded installer, then keep clicking 'Next' or 'Continue' until it says installation complete. Accept all defaults - no changes needed. Takes 1-2 minutes.",
        step4Title: "Step 4: Open Codex and Configure",
        step4Desc: "Double-click the Codex icon on your desktop. Find 'Settings' (usually a gear icon in the top-right corner), then look for 'API Configuration' or 'Custom Endpoint'. You will see two input fields:",
        step5Title: "Step 5: Enter API Base URL",
        step5Desc: "In the first field (Base URL / API Endpoint), paste: https://api.lxjfly.com",
        step6Title: "Step 6: Enter API Key",
        step6Desc: "In the second field (API Key), paste the key you copied in Step 1.",
        step7Title: "Step 7: Save and Start Using",
        step7Desc: "Click 'Save' or 'Confirm'. Go back to the Codex main screen. You can now chat with it - type what you want to do in the input box and Codex will help you automatically.",
    ...
    claude: {
      ...
      step1Desc: 'Follow the Anthropic documentation to install Claude Code CLI.',
      step2Title: 'Get API Key',
      step2Desc: 'Generate an API Key on this platform for Claude Code authentication.',
      step3Title: 'Configure custom API endpoint',
      step3Desc: 'Set the environment variable to route Claude Code requests through this platform:',
    },
    gemini: {
      step1Title: 'Install Gemini CLI',
      step1Desc: 'Visit the Google Gemini CLI page and download the CLI tool for your OS.',
      step2Title: 'Get API Key',
      step2Desc: 'Generate an API Key on this platform as your Gemini CLI credential.',
      step3Title: 'Set API Key',
      step3Desc: 'Set your API Key as an environment variable:',
      step4Title: 'Configure custom API endpoint',
      step4Desc: 'Set the custom API endpoint environment variable:',
    },
    chatbox: {
      step1Title: 'Download ChatBox',
      step1Desc: 'Visit chatboxai.app to download the desktop client or use the web version.',
      step2Title: 'Add Custom Provider',
      step2Desc: 'Open ChatBox Settings → AI Provider → Add Custom Provider.',
      step3Title: 'Fill in API details',
      step3Desc: 'Set API URL to https://api.lxjfly.com and paste your API Key.',
      step4Title: 'Select model and start chatting',
      step4Desc: 'Save and select your new provider in the chat interface to start using.',
    },
  },
}
