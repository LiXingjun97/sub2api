export default {
  ...
  userManual: {
      ...
      codex: {
        step1Title: '安装 Codex',
        step1Desc: '访问 Codex 官方下载页面，下载对应操作系统的安装包并完成安装。',
        step2Title: '登录 Codex',
        step2Desc: '安装完成后在终端运行登录命令，按提示完成 OpenAI 账号登录。',
        step3Title: '执行登录命令',
        step3Desc: '在终端中运行以下命令开始登录流程：',
        step4Title: '配置自定义 API 地址',
        step4Desc: '登录完成后，设置环境变量指向本平台的 API 地址。',
        step5Title: '设置环境变量',
        step5Desc: '在终端中运行以下命令（Windows 用 set 替代 export）：',
      },
      claude: {
